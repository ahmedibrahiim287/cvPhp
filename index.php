...
?>
 <header class="page__header">
  ...
  <main>
    ...
    <section id="info" data-nav="info">
      <div class="landing__container">
        ...
        <p class="liP">A fresh graduate. Passionate about Web development, specialized in front end development.
          Experienced with
          all stages of the development cycle for dynamic web projects. Well-versed in numerous programming languages
          including HTML, CSS, JavaScript, jQuery, Angular, and Node JS.</p>
      </div>
    </section>

    <!--Sections 2 -->
    <section id="Education" data-nav="Education" class="your-nactive-class">
      <div class="landing__container"><br><br>
        <h2>Education</h2>
        <p class="liP">Bachelor in Business Information System (BIS) from Helwan University, Faculty of Commerce and
          Business
          Administration.
          <ul>
    ...
    <!--Sections 3 -->
    <section id="Skills" data-nav="Skills" class="your-nactive-class">
      <div class="landing__container">
        <h2>Skills</h2>
        <p>
    ...
    <!--Sections 4 -->
    <section id="Experience" data-nav="Experience" class="your-nactive-class">
      <div class="landing__container">
    ...
    <!--Sections 5 -->
    <section id="Memberships" data-nav="Memberships" class="your-nactive-class">
      <div class="landing__container">
        <h2>Memberships & Achievements</h2>
        <p>
          <ul class="lihi">
            <li> Participant in NASA's space apps Cairo 2018.</li>
            <li>Participant in Vodafone innovation hackathon'18 010, one of the top 10 winner teams and the winner team
              of
            ...
            <li> A representative of a seminar in the library of Alexandria and El Sawy Culturewheel about children
              without
              shelter.</li>
    ...
    <!--Sections 6-->
    <section id="Courses" data-nav="Courses">
      <div class="landing__container">
        <h2>Courses</h2>
        <p>
          <ul class="edLI">
